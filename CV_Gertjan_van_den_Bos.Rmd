...
* Time Series, Forecasting, Anomaly Detection, Classification, Machine Learning, Data Wrangling, Data Visualization, Dashboarding, Process Automation

## Languages

* R (advanced): i.a. dplyr, tidyr, ggplot2, shiny, forecast, caret, purrr, data.table
* Python (intermediate): i.a. pandas, numpy, TensorFlow, Keras, PySpark
...
ING_finance <- c("Data Scientist", "ING Bank N.V. - Finance Analytics", "2016 - present", "Amsterdam")
